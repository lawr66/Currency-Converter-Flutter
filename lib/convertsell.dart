...
class ConvertSell extends StatefulWidget {
  @override
  ConvertSellState createState() => ConvertSellState();
}

class ConvertSellState extends State<ConvertSell> {
              ...
              ElevatedButton(
                ...
                onPressed: () {
                  setState(() {
                    ...
                    globals.currentBox.get(selectedValue1).sellValue : globals.currentBox.get(selectedValue1).sellValue / 100;

                    double valueTo = !globals.currentBox.get(selectedValue2).name.contains('100') ?
                    globals.currentBox.get(selectedValue2).sellValue : globals.currentBox.get(selectedValue2).sellValue / 100;
